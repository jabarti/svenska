...
echo "<table class='visaButtonEdit'>";
    echo "<tr>";
    echo "<td><button class='butt_insert_znakiEdit' id='butt_another'  value=' ≠ _".$curr_word_id."'>\"<span class='red'>≠</span>\" ".t("inne znaczenia podobnych wyrazów")."</button></td>";
    echo "<td><button class='butt_insert_znakiEdit' id='butt_antonym'  value=' <=> _".$curr_word_id."'>\"<span class='red'><=></span>\" ".t("wyrazy o przeciwnych znaczeniach (antonimy)")."</button></td>";
    echo "<td><button class='butt_insert_znakiEdit' id='butt_synonym'  value=' == _".$curr_word_id."'>\"<span class='red'>==</span>\" ".t("wyrazy o podobnych znaczeniach (synonimy)")."</button></td>";
    echo  "</tr>"
        . "<tr>";
    echo "<td><button class='butt_insert_znakiEdit' id='butt_synonym'  value=' => _".$curr_word_id."'>\"<span class='red'>=></span>\" ".t("zobacz też")."</button></td>";
    echo "<td><button class='butt_insert_znakiEdit' id='butt_transit'  value='transitivt; _".$curr_word_id."'>\"<span class='red'>transitivt</span>\" ".t("czasownik przechodni np.: jag dödar någon")."</button></td>";
    echo "<td><button class='butt_insert_znakiEdit' id='butt_intrans'  value='intransitivt; _".$curr_word_id."'>\"<span class='red'>intransitivt</span>\" ".t("czasownik nieprzechodni np.: Jag dör")."</button></td>";
echo "</tr></table>";         
