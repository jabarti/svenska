...
define('VIEWS_PATH', INCLUDE_PATH . 'views'.DIRECTORY_SEPARATOR);
define('FUNCTIONS_PATH', INCLUDE_PATH  . 'functions'.DIRECTORY_SEPARATOR);
define('FUNCTIONS2_PATH', 'Includes/functions'.DIRECTORY_SEPARATOR);
